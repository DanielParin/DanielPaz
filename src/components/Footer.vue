  ...
  <footer class="border-t border-border py-10">
    <div class="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <p class="text-slate-600 text-sm text-center">
        Designed &amp; built by <span class="text-slate-400 font-medium">Daniel Paz Rincón</span> · {{ year }}
      </p>
      <div class="flex items-center gap-3">
        <a href="https://github.com/DanielParin" target="_blank" rel="noopener" class="footer-link" aria-label="GitHub">
        ...
        <a href="mailto:dpazrincon@gmail.com" class="footer-link" aria-label="Email">
        ...
        <a href="https://www.linkedin.com/in/daniel-paz-rincon" target="_blank" rel="noopener" class="footer-link" aria-label="LinkedIn">
...
.footer-link {
  ...
  border: 1px solid #1c2333; color: #64748b; transition: all 0.2s ease;
}
.footer-link:hover { border-color: #4f8ef7; color: #4f8ef7; }
</style>
